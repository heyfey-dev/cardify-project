        ...
        <Carousel.Item>
                        <Form onSubmit={formik.handleSubmit}>
                                                <p>PERSONAL DETAILS</p>
                                                  <h6 style={{fontSize:"12px"}}>Please make sure the details are correct as they will be used to verify your identity..</h6>
                                        ...
                                        <div style={{ marginTop: "20px", gap: "10px", display: "flex" }} className='buttom-container'>
